...
def aggiorna_azione_successiva_sicura(esito, stato_runtime):
    ...
    try:
        ...
        logger.warning(
            "[AGENTIC] Errore aggiornando azione successiva: {}".format(e)
        )
        return None
...
def registra_feedback_condizioni_sicuro(esito, stato_runtime):
    ...
    try:
        ...
        logger.warning(
            "[AGENTIC] Errore aggiornando memoria condizioni da osservazione: {}".format(e)
        )
        return []
...
def valuta_goal_intent_sicuro(mondo, firma, stato_runtime, world_model=None):
    ...
    try:
        ...
        logger.warning(
            "[AGENTIC] Errore goal/intent reasoning: {}".format(e)
        )
        return {
            "goal_attivo": False,
...
def costruisci_decisione_goal_sicura(esito_goal):
    ...
    try:
        ...
        logger.warning(
            "[AGENTIC] Errore decisione goal/intent: {}".format(e)
        )
        return None
...
def costruisci_decisione_azione_successiva_sicura(stato_runtime):
    ...
    try:
        ...
        logger.warning(
            "[AGENTIC] Errore costruendo azione successiva: {}".format(e)
        )
        return None
...
def esegui_ciclo_agentico(
    ...
    try:
        ...
        if decisione_azione_successiva is not None:
            stato["decisione"] = decisione_azione_successiva
            stato["motivo"] = "azione_successiva_goal"
            stato["step"].append("decisione_azione_successiva_goal")
            logger.info("[AGENTIC] Decisione da azione successiva suggerita")
        ...
        if decisione_goal is not None:
            stato["decisione"] = decisione_goal
            stato["motivo"] = "goal_intent"
            stato["step"].append("decisione_goal_intent")
            logger.info("[AGENTIC] Decisione da goal/intent reasoning")
            registra_revisione_piano_corrente(
                stato_runtime,
                decisione_goal
            )
